...
VectorStrategy::VectorStrategy(vector<int>& unsuited_strategy, vector<int>& suited_strategy, string& name):
        unsuited_strategy_ (unsuited_strategy), suited_strategy_(suited_strategy), name_(name)
{}

Action VectorStrategy::GetAction(Card card_a, Card card_b) {
